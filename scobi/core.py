...
class Environment(Env):
    def __init__(self, env_name, mods=None, seed=None, focus_dir="resources/focusfiles", focus_file=None, reward=0, hide_properties=False, silent=False, refresh_yaml=True, draw_features=False, hud=False):
        ...
        self.oc_env = em.make(env_name, self.logger, mods, hud=hud, buffer_window_size=2)
        self.seed = seed
    ...
    def step(self, action):
        if not self.did_reset:
            ...
            #sco_obs, sco_reward = self.focus.get_feature_vector_nearest_obj(obs)
    ...
    def reset(self, *args, **kwargs):
        ...
        #sco_obs, _ = self.focus.get_feature_vector_nearest_obj(obs)
